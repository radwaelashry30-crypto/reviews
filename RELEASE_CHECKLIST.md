...
| Item | Status | Note |
|---|---|---|
| All Critical/High issues from the audit fixed | ✅ | Rate limiting, upload-size cap, ABSA hallucination, fake-review disclaimer — all fixed and tested this round |
...
| Model limitations/disclaimers visible | ✅ | README §38–40, `MODEL_CARD.md`, and in-product disclaimers on Task 2/Task 3 results |
...
- The fake-review detection module (Task 2) is confirmed unreliable at the model level, not fixable by this codebase, and is presented accordingly (disclosed, de-emphasized, never treated as a validated signal).
